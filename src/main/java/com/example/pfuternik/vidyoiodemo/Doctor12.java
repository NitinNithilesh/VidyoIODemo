...
public class Doctor12 extends AppCompatActivity implements Connector.IConnect {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor12);
    ...
    public void Connect(View v) {
        ...
        vc.connect("prod.vidyo.io", token, "Patient", "Doctor12", this);
    }
