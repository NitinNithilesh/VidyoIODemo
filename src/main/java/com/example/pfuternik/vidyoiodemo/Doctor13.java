...
public class Doctor13 extends AppCompatActivity implements Connector.IConnect {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor13);
    ...
    public void Connect(View v) {
        ...
        vc.connect("prod.vidyo.io", token, "Patient", "Doctor13", this);
    }
