...
public class Doctor7 extends AppCompatActivity implements Connector.IConnect {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor7);
    ...
    public void Connect(View v) {
        ...
        vc.connect("prod.vidyo.io", token, "Patient", "Doctor7", this);
    }
