...
public class Doctor8 extends AppCompatActivity implements Connector.IConnect {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor8);
    ...
    public void Connect(View v) {
        ...
        vc.connect("prod.vidyo.io", token, "Patient", "Doctor8", this);
    }
