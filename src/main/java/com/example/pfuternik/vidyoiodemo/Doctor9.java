...
public class Doctor9 extends AppCompatActivity implements Connector.IConnect {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor9);
    ...
    public void Connect(View v) {
        ...
        vc.connect("prod.vidyo.io", token, "Patient", "Doctor9", this);
    }
